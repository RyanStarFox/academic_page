...
<div class="exp-grid" role="region" aria-label="Experiences">
  <div class="exp-card">
    ...
    <div class="exp-card-body">
      ...
      <p class="exp-card-role">Research Intern, SURFI Lab</p>
      <p class="exp-card-mentor">Advisor: <a href="https://henrygwb.github.io/" target="_blank" rel="noopener">Wenbo Guo</a></p>
      <p class="exp-card-period">2026.02 – Present</p>
    </div>
  </div>
  ...
  <div class="exp-card">
    ...
    <div class="exp-card-body">
      ...
      <p class="exp-card-role">SoC Summer Workshop, Cloud Computing <span class="exp-card-tag">1st Place</span></p>
      <p class="exp-card-mentor">Advisor: <a href="https://scholar.google.com/citations?user=gdyYJz4AAAAJ&hl=en" target="_blank" rel="noopener">Tianbai Ma</a></p>
      <p class="exp-card-period">2025.07</p>
    </div>
  </div>
  ...
  <div class="exp-card">
    ...
    <div class="exp-card-body">
      ...
      <p class="exp-card-role">B.S. in Computer Science</p>
      <p class="exp-card-period">2023.09 – Present</p>
    </div>
  </div>
  ...
  <div class="exp-card">
    ...
    <div class="exp-card-body">
      ...
      <p class="exp-card-role">Student</p>
